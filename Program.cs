    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else if (userInput == "7")
            {
                ...
                Console.WriteLine("You have initialized the news scraper, it will look for the top story every 4 hours and post it");
                Console.WriteLine("The hashtags will be generated by the first word in the article and then my own");
                /**********start helper program************/
